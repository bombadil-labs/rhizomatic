...
- `reading` lives in the hyperschema body, so all sibling readings over a gather share the *child's* reading — "what a post *is* when embedded here" is part of the gather program's identity, not of any particular parent lens.
